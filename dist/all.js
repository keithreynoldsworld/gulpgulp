	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				"form",
				null,
				React.createElement("input", { type: "text", placeholder: "add a comment" }),
				React.createElement(
					"button",
					{ type: "submit" },
					"add comment"
...
},{"./comment":157,"react":156}],159:[function(require,module,exports){
'use strict';

var React = require('react');
var InstagramImage = require('./components/image');
var InstagramComment = require('./components/comment');
React.render(React.createElement(InstagramImage, { imageUrl: 'http://wdy.h-cdn.co/assets/cm/15/10/54f5f978eea3a_-_01-pickle-on-white-lgn-41585088.jpg' }), document.getElementById('container'));

},{"./components/comment":157,"./components/image":158,"react":156}]},{},[159])
